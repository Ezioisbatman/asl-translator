...
#with open(r'C:\Users\bhuta\Desktop\sl\sign-language-new\test_images', "wb") as f:
#	pickle.dump(test_images, f)
#del test_images

#test_labels = labels[int(5/6*len(labels)):int(11/12*len(images))]
#print("Length of test_labels", len(test_labels))
#with open(r'C:\Users\bhuta\Desktop\sl\sign-language-new\test_labels', "wb") as f:
